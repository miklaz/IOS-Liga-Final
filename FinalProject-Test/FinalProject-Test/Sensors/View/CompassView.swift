...
final class CompassView: UIView {
    ...
    private var halfFrameWidth: CGFloat = 0
    private var fullFrameWidth: CGFloat = 0
    private let needleBottomWith: CGFloat = 10
    private var needleLength: CGFloat = 0
    private var centerView: CGPoint?
    private var changeDegree = 90
    ...
    private func createCompassMarks() {
    ...
    private func arcLocationPoint(degree: CGFloat, distance: CGFloat) -> CGPoint {
    ...
    private func addDegree(degree: Int, location: CGPoint) {
    ...
    private func addDirection(direction: String, degree: Int, location: CGPoint) {
        let textLayer = CATextLayer()
