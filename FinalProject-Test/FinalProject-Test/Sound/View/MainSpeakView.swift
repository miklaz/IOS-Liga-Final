...
class MainSpeakView: UIView {
    ...
    lazy var infoLabel = BaseUILabel(text: "← Make sure the sound switch is in the RING position",
                                       fontSize: 20,
                                       fontWeight: .medium,
                                       textColor: .label,
                                       cornerRadius: 13)
...
//        view.addSubview(dismissButton)
        ...
        NSLayoutConstraint.activate([
            ...
            infoLabel.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 74),
